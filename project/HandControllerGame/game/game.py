...
pygame.display.set_caption("Endless Cat Simulator")
...
while running:
    ...
    if not game_over:
        ...
        # Calculate score
        score = 3 * current_time  # 3 points for every passing second
        score += 10 * (2 * minutes)  # 10 points for avoiding each cactus
