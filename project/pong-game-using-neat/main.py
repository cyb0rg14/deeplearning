...
def train_ai(config):
    ...
    with open("best_trained_ai.pickle", "wb") as f:
...
def test_ai(config):
    ...
    with open("best_trained_ai.pickle", "rb") as f:
...
if __name__ == "__main__":
    print("This is just a helper file. Please run the game.py file instead.")
